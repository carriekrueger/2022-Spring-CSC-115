...
public class MethodDemo {
    public static void main(String[] args) {
        ...
        // DEFINED in the same place where it is CALLED
        ...
        if(choice == 3) {
            ...
            int answer = square(num1);   // returns a value and saves it to a variable
        ...
        if(choice == 4) {
            //int answer = exp(num1, num2); //returns a value and saves it to a variable
            //System.out.println(answer);
    ...
    // This method takes two ints. It returns a raised to b power.

    public static int exp(int a, int b) {
        // return Math.pow(a, b);   // cheat code... let's write our own! (would need to change return type to double)
